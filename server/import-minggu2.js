...
async function importMinggu2() {
  ...
  try {
    ...
    // Header di row index 3, data mulai row index 4
    const header = rows[3];
    const dateCols = [];
    ...
    console.log(`Ditemukan ${dateCols.length} tanggal (01-07):`, dateCols.map(d => d.date));
