          ...
          <div className="p-6">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                disabled={loading}
                className="px-6 py-2.5 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 disabled:opacity-50 flex items-center gap-2 transition-all"
              >
                {loading ? (
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold">{lookupResult.supplier.name}</h3>
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="bg-gray-50">
                        ...
                        <th className="px-4 py-3 text-left font-medium text-gray-600">Exp</th>
                        <th className="px-4 py-3 text-center font-medium text-gray-600">Stok</th>
                        <th className="px-4 py-3 text-center font-medium text-gray-600">Dibeli</th>
                      ...
                      {lookupResult.items.map(item => {
                        ...
                        return (
                          <tr key={item.batch_id} className={`hover:bg-gray-50/50 transition-colors ${disabled ? 'opacity-40' : ''}`}>
                            ...
                            <td className="px-4 py-3 text-gray-500">{item.expired_date ? new Date(item.expired_date).toLocaleDateString('id-ID', { day: 'numeric', month: 'short', year: 'numeric' }) : '-'}</td>
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                  <div>
                    ...
                    <textarea
                      className="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all resize-none"
                      rows={3}
                      value={reason}
                ...
                <div className="flex justify-end gap-3 pt-4 border-t border-gray-100">
                  ...
                  <button
                    ...
                    className="px-6 py-2.5 bg-gradient-to-r from-blue-600 to-blue-500 text-white font-medium rounded-xl hover:from-blue-700 hover:to-blue-600 disabled:opacity-50 flex items-center gap-2 shadow-sm shadow-blue-200 transition-all"
                  >
                    {submitting ? (
            ...
            <div className="p-6 text-center">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  disabled={submitting}
                  className="flex-1 px-4 py-2.5 bg-blue-600 text-white font-medium rounded-xl hover:bg-blue-700 disabled:opacity-50 transition-all"
                >
